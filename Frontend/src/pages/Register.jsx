    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] relative p-4 py-8">
      <div className="w-full max-w-[420px] p-8 md:p-10 bg-white rounded-[24px] shadow-sm border border-[#F1DDC8]">
        ...
        <form className="space-y-4">
          ...
          <button 
            type="submit" 
            className="w-full !mt-6 bg-[#203461] text-white font-medium py-3.5 px-4 rounded-xl hover:bg-[#15254a] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1D3260]"
          >
            Register
          </button>
        </form>
        ...
        <div className="mt-8 text-center space-y-4">
          <p className="text-[15px] text-[#203461]">
            <span className="text-slate-500">Already have an account?</span> <Link to="/login" className="font-semibold hover:underline">Login</Link>
          </p>
